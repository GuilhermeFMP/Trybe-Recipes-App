...
Décimo projeto de Front-End fornecido pela instituição Trybe realizado em grupo, onde criamos uma aplicação de receitas.


## Aprendizados

Aprendi e coloquei em pratica tudo o que já tinha visto até então.

## Stack utilizada

**Fundamentais:** React, JS e RTL
...
```bash
  git@github.com:GuilhermeFMP/Trybe-Recipes-App.git
